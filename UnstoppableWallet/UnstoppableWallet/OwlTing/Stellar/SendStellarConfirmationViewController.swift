...
class SendStellarConfirmationViewController: ThemeViewController {
    let disposeBag = DisposeBag()

    let transactionViewModel: SendStellarConfirmationViewModel
    ...
    init(transactionViewModel: SendStellarConfirmationViewModel, feeViewModel: SendFeeViewModel) {
        self.transactionViewModel = transactionViewModel
        self.feeViewModel = feeViewModel

        feeCell = FeeCell(viewModel: feeViewModel, title: "fee_settings.network_fee".localized)
    ...
    private func row(viewItem: SendStellarConfirmationViewModel.ViewItem, rowInfo: RowInfo) -> RowProtocol {
        switch viewItem {
    ...
    private func section(sectionViewItem: SendStellarConfirmationViewModel.SectionViewItem, index: Int) -> SectionProtocol {
        return Section(
            id: "section_\(index)",
    ...
    private func doubleAmountRow(tableView: SectionsTableView, rowInfo: RowInfo, item: SendStellarConfirmationViewModel.StellarFeeViewItem) -> RowProtocol {
...
extension SendStellarConfirmationViewController: SectionsDataSource {
